...
export const metadata: Metadata = {
  title: "About | Mansurbek Atayev",
  metadataBase: new URL("https://atayev.uz/about"),
  description: "Learn more about my skills, experience and technical background",
  openGraph: {
    title: "About | mANSURBEK Atayev",
    url: "https://atayev.uz/about",
    description: "Learn more about my skills, experience and technical background",
          ...
          <div className="order-2 lg:order-none">
            <Slide>
              ...
              <div className="dark:text-zinc-400 text-zinc-600 leading-relaxed">
                Hey there! My name is Mansurbek.
                <br /><br />
                I began my coding journey with Node.js and React.JS developing web services and highload projects. This led me to explore the NestJS later in my journey.
                <br /><br />
                Later, my interest in Python guided me towards web scraping, and I built some useful tools that I use regularly.
                <br /><br />
              </div>
            </Slide>
          </div>
