...
export const metadata: Metadata = {
  title: "Projects | Mansurbek Atayev",
  metadataBase: new URL("https://atayev.uz/projects"),
  description: "Explore projects built by Mansurbek Atayev",
  openGraph: {  
    title: "Projects | Mansurbek Atayev",
    url: "https://atayev.uz/projects",
    description: "Explore projects built by Mansurbek Atayev",
